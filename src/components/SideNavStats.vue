<template>
  <div class="px-3">
    <div class="d-flex justify-space-between align-center pt-2">
      ...
      <h4
        class="font-weight-regular cursor-pointer stat-width ao5-padding"
        @click="ao5Modal = true"
      >
      ...
      <v-dialog overlay-opacity="0.2" v-model="ao5Modal" max-width="400px">
        <v-card>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="primary darken-1" text @click="ao5Modal = false">
              Close
            </v-btn>
          </v-card-actions>
        </v-card>
      ...
      <h4
        class="font-weight-regular stat-width cursor-pointer mr-n6"
      ...
      <v-dialog overlay-opacity="0.2" v-model="ao12Modal" max-width="400px">
        <v-card>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="primary darken-1" text @click="ao12Modal = false">
              Close
            </v-btn>
          </v-card-actions>
        </v-card>
    ...
    <div class="d-flex justify-space-between align-center pb-2">
      ...
      >
        <v-card>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="primary darken-1" text @click="addTimeModal = false">
              Close
            </v-btn>
            <v-btn
              :disabled="!valid"
      ...
      <h4 class="font-weight-regular stat-width pl-3">
        Mean: <span class="font-weight-bold">{{ currentMean }}</span>
      </h4>
      <h4
        class="font-weight-regular stat-width mr-n6 cursor-pointer"
      ...
      <v-dialog overlay-opacity="0.2" v-model="bestTimeModal" max-width="400px">
        <v-card>
          <v-toolbar color="primary" class="text-h5" dark>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="primary darken-1" text @click="bestTimeModal = false">
              Close
            </v-btn>
          </v-card-actions>
        </v-card>
